...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "features.shield.title": "Protection des avis n\u00e9gatifs",
    "features.shield.desc": "Les avis 1-3 \u00e9toiles restent priv\u00e9s. Recevez le feedback pour vous am\u00e9liorer.",
    "features.redirect.title": "Redirection Google intelligente",
    "features.redirect.desc": "Les clients satisfaits sont redirig\u00e9s vers votre page Google pour laisser un avis.",
    ...
    "dash.threshold.help": "Les notes >= ce seuil seront redirig\u00e9es vers Google",
