...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "how.step3.title": "Le client choisit o\u00f9 laisser son avis",
    ...
    "features.shield.desc": "Recevez les retours de vos clients en priv\u00e9 pour vous am\u00e9liorer.",
  ...
  en: {
    ...
    "how.step3.title": "Customer chooses where to leave feedback",
    ...
    "features.shield.desc": "Receive customer feedback privately to improve your service.",
